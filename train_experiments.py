...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='configs/experiment.yaml', help='Configuration file to use')
    ...
    dataloader, dataset = create_dataloaders('data/data/Exp1/', [352, 352], batch_size)
    train_ratio = 0.8
    val_ratio = 0.2
